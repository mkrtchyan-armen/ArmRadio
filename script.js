const XML_URL = "https://radio.armblog.net/channels.txt";
        ...
        const translations = {
            'en': {
                ...
                'btn-send': 'Send Message', 'badge-new': 'New', 'badge-soon': 'Beta testing', 'text-listen-online': 'Start Listening',
                'player-status': 'Live Stream',
				'btn-apk': 'Download APK',
				'msg-https': 'In the web version, radio stations whose domain is not https may not play. There is no such problem in the mobile application',
                'features': [
                    ...
                    {icon: '➕', title: 'Custom Stations', desc: 'Add your own streaming URLs'},
                    {icon: '🚗', title: 'Android Auto', desc: 'Listen to and control the radio app on your car’s display using Android Auto.', isSoon: true}
                ]
            },
            'am': {
                ...
                'section-title': 'Նախագծված է լավագույն փորձի համար', 'section-subtitle': 'Պարզ, հուսալի և միշտ թարմացված',
                ...
                'btn-send': 'Ուղարկել', 'badge-new': 'ՆՈՐ', 'badge-soon': 'Բետա-փորձարկում', 'text-listen-online': 'Լսել հիմա',
                'player-status': 'Ուղիղ եթեր',
				'btn-apk': 'Ներբեռնել APK',
				'msg-https': 'Վեբ տարբերակում կարող են չնվագարկվել այն ռադիոկայանները, որոնց դոմեյնը https չի: Բջջային հավելվածում նմանատիպ խնդիր չկա',
                'features': [
                    ...
                    {icon: '➕', title: 'Սեփական կայաններ', desc: 'Ավելացրեք ձեր սեփական կայանների հղումները'},
                    {icon: '🚗', title: 'Android Auto', desc: 'Լսեք և կառավարեք ռադիո հավելվածը մեքենայի էկրանին՝ Android Auto-ի միջոցով։', isSoon: true}
                ]
            },
            'ru': {
                ...
                'btn-send': 'Отправить', 'badge-new': 'НОВОЕ', 'badge-soon': 'Бета-тестирование', 'text-listen-online': 'Слушать сейчас',
                'player-status': 'Прямой эфир',
				'btn-apk': 'Скачать APK',
			'msg-https': 'В веб-версии могут не воспроизводиться радиостанции без протокола https. В мобильном приложении такой проблемы нет.',
                'features': [
                    ...
                    {icon: '➕', title: 'Свои станции', desc: 'Добавление своих ссылок)'},
                    {icon: '🚗', title: 'Android Auto', desc: 'Слушайте и управляйте радио-приложение на экране автомобиля с помощью Android Auto', isSoon: true}
                ]
            }
        };
        ...
        function setLanguage(lang) {
			...
			document.getElementById('btn-apk-text').textContent = data['btn-apk'];
			document.getElementById('msg-https-text').textContent = data['msg-https'];
